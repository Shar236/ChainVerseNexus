        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 text-xl">
              <a href="https://x.com/Sharvan_7X" aria-label="Twitter" className="hover:text-white"><FaTwitter /></a>
              <a href="https://instagram.com/itz_sharvan_kumar" aria-label="Instagram" className="hover:text-white"><FaInstagram /></a>
              <a href="https://github.com/Shar236/ChainVerseNexus" aria-label="GitHub" className="hover:text-white"><FaGithub /></a>
              <a href="https://www.linkedin.com/in/sharvankumar236" aria-label="Linkedin" className="hover:text-white"><FaLinkedin /></a>
            </div>
          </div>
        </div>
